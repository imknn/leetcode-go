...
| 分类 | 题数 | 说明 |
|------|------|------|
| [数组](array/README.md) | 20 | 两数之和、三数之和、盛最多水的容器等 |
| [字符串](string/README.md) | 23 | 最长回文子串、无重复子串、反转字符串等 |
| [链表](linked_list/README.md) | 6 | 两数相加、合并链表、删除节点等 |
| [栈/队列](stack_queue/README.md) | 2 | 有效的括号、删除外层括号 |
| [二分查找](binary_search/README.md) | 3 | 寻找中位数、搜索插入位置、平方根 |
| [动态规划](dynamic_programming/README.md) | 4 | 正则表达式匹配、最大子数组和、爬楼梯等 |
...
| [回溯](backtracking/README.md) | 4 | 电话号码组合、解数独、子集等 |
